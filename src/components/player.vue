      ...
      <div class="content">
        <div class="song">
          ...
          <div class="right">
            ...
            <empty v-if="nolyric">No lyrics yet~</empty>
            <Scroller
              :data="lyric"
        ...
        <div class="bottom">
          ...
          >
            ...
            <div v-else>
              ...
              >
                <p class="title">A playlist containing this song</p>
                <div
                  :key="simiPlaylist.id"
                  class="simi-item"
...
// Restore the timer time of automatic scrolling
...
export default {
  ...
  methods: {
    ...
    onInitScroller(scoller) {
      ...
      const onScrollEnd = type => {
        // The lyrics begin to scroll automatically two seconds after the scroll ends
        this.clearTimer(type)
    ...
    onClickPlaylist(id) {
      // The playlist clicked is the same as the currently open single page
  ...
  computed: {
    ...
    lyricWithTranslation() {
      ...
      // content Unifies the array form
  ...
  watch: {
    isPlayerShow(show) {
      if (show) {
        // Lyrics will not change in the short term, so only similar information is pulled
        this.updateSimi()
    ...
    currentSong(newSong, oldSong) {
      ...
      // If the song details show the status, you need to pull the song information
      if (this.isPlayerShow) {
        this.updateSong()
      } else {
        // Otherwise just update the lyrics
        this.updateLyric()
      }
    },
