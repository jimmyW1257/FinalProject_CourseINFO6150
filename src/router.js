...
const Songs = () =>
    import ( /* webpackChunkName: "Songs" */ '@/page/songs')
const Search = () =>
    import ( /* webpackChunkName: "Search" */ '@/page/search')
const SearchSongs = () =>
...
const Mvs = () =>
    import ( /* webpackChunkName: "Mvs" */ '@/page/mvs')
const Mv = () =>
    import ( /* webpackChunkName: "Mv" */ '@/page/mv')

// Pages with centered content
